...
// const kafka = new Kafka({ clientId: 'healthcare-consumer', brokers: ['localhost:9092'] });
// const consumer = kafka.consumer({ groupId: 'healthcare-group' });
...
//   await consumer.subscribe({ topic: 'healthcare-data', fromBeginning: true });
